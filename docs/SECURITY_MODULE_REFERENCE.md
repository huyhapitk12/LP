...
LP Security cung cấp 2 cách để bảo vệ ứng dụng:

1. **@security decorator** - Tự động chèn security checks vào đầu hàm
2. **security module** - Gọi các hàm security trực tiếp từ code
