...
This is the same style used by `examples/02_oop_game_engine.lp`.
...
This pattern is verified by `examples/test_inheritance_access.lp`.
...
- [Error Handling and Advanced Control Flow](06_Error_Handling_and_Advanced_Control_Flow.md)
